...
pas=0.005 # pas fixe
eps=0.003 # espilon
diff=1000 #Valeur elevee pour commencer a iterer
tab=[]
...
while(diff>eps and i<NbIter) :
    ...
    # Iteration
    q=q-pas*np.dot(Jt,H)
    #Comparaison de la premiere coordonne de q a celle de qbut
    diff=q[0]-qbut[0]
...
# Trace de l evolution de l erreur
